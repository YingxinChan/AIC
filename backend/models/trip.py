...
class Trip(Base):
    ...
    arrival_other_time: Mapped[str] = mapped_column(String(10), default="", server_default="")
    ...
    departure_other_time: Mapped[str] = mapped_column(String(10), default="", server_default="")

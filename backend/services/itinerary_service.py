    ...
    try:
        response = await client.messages.create(
            ...
            system=(
                ...
                f"as decimal degrees, using your own knowledge of that specific activity's "
                f"actual location in {destination} — not a placeholder, not the city's "
                f"center point, and not any location mentioned elsewhere in these "
                f"instructions. "
